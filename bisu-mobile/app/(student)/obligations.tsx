...
export default function StudentObligations() {
  ...
  const progressFill = isDark ? '#818cf8' : '#0f172a';
    ...
    <StudentPageWrapper activeRoute="obligations">
      <View style={{ flex: 1, backgroundColor: bg }}>
        ...
        <View style={{ backgroundColor: bg, paddingHorizontal: 20, paddingTop: 20, paddingBottom: 16 }}>
           <Text style={{ fontSize: 20, fontWeight: '800', color: textPrimary }}>Obligations</Text>
           <Text style={{ fontSize: 12, color: textSecondary, marginTop: 4 }}>Track your fees and assigned tasks</Text>
        </View>
        ...
        >
          ...
          {activeList.length === 0 ? (
            ...
            const statusBadgeBg = activeTab === 'pending'
