...
import { View, Text, ScrollView, ActivityIndicator, RefreshControl, TouchableOpacity, TextInput, Alert, Modal, Pressable } from 'react-native';
...
export default function OfficerConsequences() {
  ...
  return (
    <OfficerPageWrapper activeRoute="consequences">
      <View style={{ backgroundColor: cardBg, paddingTop: 24, paddingBottom: 16, paddingHorizontal: 20, borderBottomWidth: 1, borderBottomColor: borderLight, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', zIndex: 10 }}>
        <View style={{ flex: 1, paddingRight: 16 }}>
           <Text style={{ fontSize: 28, fontWeight: '800', color: isDark ? '#f8fafc' : '#0f2d5e' }}>Consequence Rules</Text>
           <Text style={{ color: textSecondary, fontSize: 13, marginTop: 6, lineHeight: 18 }}>Set automated actions for absent students</Text>
        </View>
        <TouchableOpacity 
          style={{ flexDirection: 'row', backgroundColor: primarySolid, paddingHorizontal: 14, paddingVertical: 10, borderRadius: 8, alignItems: 'center' }}
          onPress={openCreate}
        >
          <Plus size={16} color="#fff" strokeWidth={3} />
          <Text style={{ color: '#fff', fontWeight: '700', fontSize: 13, marginLeft: 6 }}>Add Rule</Text>
        </TouchableOpacity>
      </View>
