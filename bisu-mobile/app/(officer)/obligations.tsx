        ...
        <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 100 }} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => { setRefreshing(true); fetchData(); }} />} showsVerticalScrollIndicator={false}>
          ...
          <View style={{ paddingHorizontal: 20, paddingTop: 24, paddingBottom: 16 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
              <View style={{ width: 44, height: 44, backgroundColor: '#8b5cf6', borderRadius: 12, alignItems: 'center', justifyContent: 'center', marginRight: 12 }}>
                <BookOpen size={20} color="#fff" />
              </View>
              <View>
                <Text style={{ fontSize: 24, fontWeight: '900', color: textPrimary }}>Obligations</Text>
                <Text style={{ fontSize: 13, color: textSecondary, marginTop: 2 }}>Member fees & consequence tasks</Text>
              </View>
            </View>
          </View>
