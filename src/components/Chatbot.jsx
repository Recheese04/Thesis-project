...
export default function Chatbot() {
    ...
    const chatRef = useRef(null); // stores the chat session

    // Reactively detect login/logout
    useEffect(() => {
        const checkAuth = () => setIsLoggedIn(!!localStorage.getItem('token'));
        // Listen for storage changes (logout from another tab)
        window.addEventListener('storage', checkAuth);
        // Poll every second to catch same-tab logout
            ...
            <div className={`chatbot-container ${isOpen ? '' : 'chatbot-closed'}`}>
                ...
                <AnimatePresence>
                    {isOpen && (
                        ...
                        >
                            ...
                            <div
                                style={{
                                    background: 'linear-gradient(135deg, #0f2d5e 0%, #1a4a8a 50%, #2563eb 100%)',
                                    padding: '16px 20px',
                                    display: 'flex',
                                    alignItems: 'center',
                            ...
                            >
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', position: 'relative', zIndex: 1 }}>
                                    ...
                                    />
                                    <div>
                                        <h3 style={{ color: 'white', fontWeight: 700, fontSize: '15px', margin: 0, lineHeight: 1.2 }}>
                                            TAPasok AI
                                        </h3>
                                            ...
                                            <div style={{ maxWidth: '78%' }}>
                                                    ...
                                                    {msg.isBot ? (
                                                        <ReactMarkdown
                                                            components={{
                                                                ...
                                                                strong: ({ children }) => (
                                                                    <strong style={{ fontWeight: 600, color: '#0f2d5e' }}>{children}</strong>
                                                                ),
                                                ...
                                                <div
                                                    style={{
                                                        ...
                                                        paddingLeft: msg.isBot ? '4px' : '0',
                                                        paddingRight: msg.isBot ? '0' : '4px',
                                                    }}
                                                >
                                                    {formatTime(msg.time)}
                                                </div>
                                ...
                                <motion.button
                                    ...
                                    style={{
                                        ...
                                        background:
                                            loading || !input.trim()
                                                ? '#e2e8f0'
                                                : 'linear-gradient(135deg, #0f2d5e, #2563eb)',
                ...
                <motion.button
                    ...
                    style={{
                        ...
                        justifyContent: 'center',
                        cursor: 'pointer',
                        boxShadow: '0 8px 24px rgba(15,45,94,0.4), 0 0 0 0 rgba(37,99,235,0.4)',
                        position: 'relative',
                        marginLeft: 'auto',
                        overflow: 'hidden',
                    }}
