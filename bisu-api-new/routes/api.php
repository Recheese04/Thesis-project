...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post(
        ...
        function (Request $request, $orgId) {
            $user = $request->user();
            if (!$user->student_number) {
                return response()->json(['message' => 'Only students can join organizations.'], 403);
            }
    ...
    Route::post(
        '/organizations/{org_id}/members/{designationId}/approve',
        function (Request $request, $orgId, $designationId) {
            $user = $request->user();
    ...
    Route::post(
        '/organizations/{org_id}/members/{designationId}/reject',
        function (Request $request, $orgId, $designationId) {
            $user = $request->user();
            if (!$user->isOfficerOf($orgId)) {
